...
// node_modules/vue-simple-range-slider/dist/index.es.js
...
var ve = Math.min;
function ee(S, v, t) {
  let y, f, x, R, h, D, m = 0, C = false, c = false, T = true;
...
var ie = (S) => (me("data-v-f6e84873"), S = S(), ce(), S);
var fe = ["innerHTML"];
var he = _e("|");
var Se = ie(() => _("div", { class: "simple-range-slider-popover-arrow" }, null, -1));
var ke = ie(() => _("div", { class: "simple-range-slider-popover-arrow" }, null, -1));
var ye = ne({
...
var be = ne({
  ...
  setup(S, { emit: v }) {
    ...
    ue(() => {
      var e;
      oe(X.value, "direction") === "rtl" && (n.isRtl = true), d.ro3 = new ResizeObserver((i) => {
    ...
    const te = k(() => ({
      ...
      n.isDragging = true, n.draggingAnchor = e, n.dragStartX = i.x, e == 1 ? n.dragStartPosition = o.value : n.dragStartPosition = a.value;
      const s = window;
      s.$SRSMouseMove = (p) => {
        ...
        n.isDragging = false, document.removeEventListener("mouseup", s.mouseUp), document.removeEventListener("mousemove", s.$SRSMouseMove), p.preventDefault(), p.stopPropagation();
        ...
        _("div", {
          ...
          r(W) ? (P(), M("div", {
            ...
            _("div", {
              ...
              A(e.$slots, "prefix", { value: r(b) }, void 0, true),
              _("div", {
                ref_key: "input1",
                ref: m,
                class: "input1",
              ...
              A(e.$slots, "suffix", { value: r(b) }, void 0, true)
            ], 512),
            _("label", null, [
              _("div", {
                ...
                e.$slots.splitter ? A(e.$slots, "splitter", { key: 0 }, void 0, true) : (P(), M(pe, { key: 1 }, [
                  he
                ], 64))
              ], 512)
            ]),
            _("div", {
              ...
              A(e.$slots, "prefix", { value: r(w) }, void 0, true),
              _("div", {
                ref_key: "input2",
                ref: c,
                class: "input2",
              ...
              A(e.$slots, "suffix", { value: r(w) }, void 0, true)
            ], 512)
          ], 4)) : j("", true),
          _("div", {
            ...
            r(W) ? j("", true) : (P(), M("div", {
              ...
              _("div", {
                ...
                A(e.$slots, "prefix", { value: r(U) }, void 0, true),
                _("div", {
                  ref_key: "input1",
                  ref: m,
                  class: "input1",
                ...
                A(e.$slots, "suffix", { value: r(U) }, void 0, true)
              ], 512)
            ], 4)),
            Se
          ], 4),
          r(u) ? (P(), M("div", {
            ...
            r(W) ? j("", true) : (P(), M("div", {
              ...
              _("div", {
                ...
                A(e.$slots, "prefix", { value: r(K) }, void 0, true),
                _("div", {
                  ref_key: "input2",
                  ref: c,
                  class: "input2",
                ...
                A(e.$slots, "suffix", { value: r(K) }, void 0, true)
              ], 512)
            ], 4)),
            ke
          ], 4)) : j("", true)
...
var xe = De(be, [["__scopeId", "data-v-f6e84873"]]);
export {
  xe as default
};
//# sourceMappingURL=vue-simple-range-slider.js.map
