...
function p(e2) {
  ...
  return function(e3, n2, a2) {
    ...
    for (var u2 in t2) if (r2(s2, t2[u2], a2)) return l(e3, t2[u2], a2, o2);
    return "";
  };
  function r2(e3, t3, r3) {
    for (var n2 in r3) r3[n2].escape && (t3 = t3.replace(new RegExp(n2 + ".{1}", "g"), ""));
...
function l(e2, t2, r2) {
  for (var n2 = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], a2 = 0, o2 = 0, i2 = "", s2 = ""; a2 < t2.length && o2 < e2.length; ) {
    ...
    if (l2 && l2.pattern) l2.pattern.test(p2) && (i2 += c(p2, l2), a2++, n2 && t2[a2] && (r2[t2[a2]] ? r2[t2[a2]] && r2[t2[a2]].escape && (i2 += t2[a2 + 1], a2 += 2) : (i2 += t2[a2], a2++))), o2++;
    else if (l2 && l2.repeat) {
      var f2 = r2[t2[a2 - 1]];
      f2 && !f2.pattern.test(p2) ? a2++ : a2--;
    } else l2 && l2.escape && (u2 = t2[++a2]), n2 && (i2 += u2), p2 === u2 && o2++, a2++;
  }
  for (; n2 && a2 < t2.length; ) {
    var v2 = t2[a2];
    if (r2[v2]) {
...
var d = function() {
  function e2(n2) {
    ...
    if (r(this, e2), !n2) throw new Error("Maska: no element for mask");
    if (null != o3.preprocessor && "function" != typeof o3.preprocessor) throw new Error("Maska: preprocessor must be a function");
    if (o3.tokens) for (var s2 in o3.tokens) o3.tokens[s2] = t({}, o3.tokens[s2]), o3.tokens[s2].pattern && v(o3.tokens[s2].pattern) && (o3.tokens[s2].pattern = new RegExp(o3.tokens[s2].pattern));
  ...
  return a2 = e2, o2 = [{ key: "init", value: function() {
    ...
    }, r2 = 0; r2 < this._el.length; r2++) t2(r2);
    ...
    if (e3 && e3.type) {
      ...
      if (!e3.value && !r2 || !e3.dataset.mask) return e3.dataset.maskRawValue = "", void this.dispatch("maska", e3, t2);
      ...
      this._opts.preprocessor && (i2 = this._opts.preprocessor(i2)), e3.value = s(i2, e3.dataset.mask, this._opts.tokens), t2 && "insertText" === t2.inputType && n2 === a3.length && (n2 = e3.value.length), function(e4, t3, r3) {
        for (; t3 && t3 < e4.value.length && e4.value.charAt(t3 - 1) !== r3; ) t3++;
