...
var require_apexcharts_common = __commonJS({
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    function u(t2) {
      return function(t3) {
        if (Array.isArray(t3)) return p(t3);
      }(t2) || function(t3) {
    ...
    var m = function() {
      ...
      return r(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
        ...
        return Array.isArray(r2) ? m2 = b2.globals.dom.Paper.text(function(t4) {
          for (var a3 = 0; a3 < r2.length; a3++) v2 = r2[a3], g2 && (v2 = i2.getTextBasedOnMaxWidth(e({ text: r2[a3] }, y2))), 0 === a3 ? t4.tspan(v2) : t4.tspan(v2).newLine();
    ...
    var y = function() {
      ...
      return r(t2, [{ key: "getStackedSeriesTotals", value: function() {
        ...
        if (s2.yRange = [], s2.isMultipleYAxis) for (var c2 = 0; c2 < s2.minYArr.length; c2++) s2.yRange.push(Math.abs(s2.minYArr[c2] - s2.maxYArr[c2])), n2.push(0);
        else s2.yRange.push(Math.abs(s2.minY - s2.maxY));
    ...
    var M = function(t2) {
      ...
      if (void 0 === n2.config.tooltip.x.formatter) if ("datetime" === n2.config.xaxis.type) {
        var v2 = new T(i2);
        p2 = v2.formatDate(v2.getDate(l2), n2.config.tooltip.x.format), x2 = v2.formatDate(v2.getDate(h2), n2.config.tooltip.x.format);
      } else p2 = l2, x2 = h2;
      else p2 = n2.config.tooltip.x.formatter(l2), x2 = n2.config.tooltip.x.formatter(h2);
    ...
    var D = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (n2.globals.dataChanged && "circle" === f2.shape) if (this.dynamicAnim) {
    ...
    var H = function() {
      ...
      return r(t2, [{ key: "dataLabelsCorrection", value: function(t3, e2, i2, a2, s2, r2, o2) {
        ...
        if (!d2.enabled || !Array.isArray(a2.x)) return p2;
        ...
        for (var x2 = 0; x2 < a2.x.length; x2++) if (g2 = a2.x[x2] + d2.offsetX, u2 = a2.y[x2] + d2.offsetY + l2, !isNaN(g2)) {
          ...
          if ("bubble" === h2.config.chart.type) v2 = y2(b2 = h2.globals.seriesZ[s2][f2]), u2 = a2.y[x2], u2 = new D(this.ctx).centerTextInBubble(u2, s2, f2).y;
    ...
    var N = function() {
      ...
      return r(t2, [{ key: "isMultiFormat", value: function() {
        ...
        for (var n2 = function() {
          ...
          if (this.twoDSeries = [], this.twoDSeriesX = [], this.threeDSeries = [], void 0 === t3[l2].data) return void console.error("It is a possibility that you may have not included 'data' property in series.");
        ...
        if (e2.xaxis.categories.length > 0) i2.labels = e2.xaxis.categories;
          ...
          })), e2.xaxis.convertedCatToNumeric) new z(e2).convertCatToNumericXaxis(e2, this.ctx, i2.seriesX[0]), this._generateExternalLabels(t3);
          ...
          if (h2.length && 0 === e3 && c2.push(h2.join(r2)), t4.data) {
            ...
            for (var a3 = 0; a3 < t4.data.length; a3++) {
              ...
              if (s3 || (p2.isFormatXY() ? s3 = i2[e3].data[a3].x : p2.isFormat2DArray() && (s3 = i2[e3].data[a3] ? i2[e3].data[a3][0] : "")), 0 === e3) {
                ...
                for (var o3 = 0; o3 < l2.globals.series.length; o3++) p2.isFormatXY() ? h2.push(i2[o3].data[a3].y) : h2.push(g2[o3][a3]);
              }
      ...
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (s2.config.grid.xaxis.lines.show || s2.config.xaxis.axisTicks.show) {
          ...
          s2.globals.timescaleLabels.length ? function(t4) {
            ...
            if (void 0 !== s2.config.xaxis.tickAmount && "dataPoints" !== s2.config.xaxis.tickAmount && "on" === s2.config.xaxis.tickPlacement) s2.globals.dom.baseEl.querySelectorAll(".apexcharts-text.apexcharts-xaxis-label tspan:not(:empty)").forEach(function(t5, a4) {
              var s3 = t5.getBBox();
              e2._drawGridLines({ i: a4, x1: s3.x + s3.width / 2, y1: o3, x2: s3.x + s3.width / 2, y2: l3, xCount: i2, parent: e2.elgridLinesV });
            });
            else for (var h3 = 0; h3 < a3 + (s2.globals.isXNumeric ? 0 : 1); h3++) 0 === h3 && 1 === a3 && 1 === s2.globals.dataPoints && (n3 = r3 = s2.globals.gridWidth / 2), e2._drawGridLines({ i: h3, x1: r3, y1: o3, x2: n3, y2: l3, xCount: i2, parent: e2.elgridLinesV }), n3 = r3 += s2.globals.gridWidth / (s2.globals.isXNumeric ? a3 - 1 : a3);
        ...
        if (void 0 !== i2.config.grid.column.colors && i2.config.grid.column.colors.length > 0) for (var l2 = i2.globals.isBarHorizontal || "category" !== i2.config.xaxis.type && !i2.config.xaxis.convertedCatToNumeric ? t3 : t3 - 1, h2 = i2.globals.padHorizontal, c2 = i2.globals.padHorizontal + i2.globals.gridWidth / l2, d2 = i2.globals.gridHeight, g2 = 0, u2 = 0; g2 < t3; g2++, u2++) u2 >= i2.config.grid.column.colors.length && (u2 = 0), this._drawGridBandRect({ c: u2, x1: h2, y1: 0, x2: c2, y2: d2, type: "column" }), h2 += i2.globals.gridWidth / l2;
      } }]), t2;
    }();
    var _ = function() {
      function t2(e2) {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        var m2 = t3;
        (l2 = []).push(m2);
        for (var y2 = Math.abs(e2 - t3) / i2, w2 = 0; w2 <= i2; w2++) m2 += y2, l2.push(m2);
        ...
        t3 || (t3 = this);
        var a2 = t3.w;
        if (a2.globals.isMultipleYAxis || a2.globals.collapsedSeries.length) return console.warn("autoScaleYaxis is not supported in a multi-yaxis chart."), e2;
    ...
    var U = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if (t3.isXNumeric && function() {
          ...
          else t3.xAxisScale = this.scales.linearScale(1, a2, a2), t3.noLabelsProvided && t3.labels.length > 0 && (t3.xAxisScale = this.scales.linearScale(1, t3.labels.length, a2 - 1), t3.seriesX = t3.labels.slice());
        ...
        if (t3.series.length) for (var a2 = 0; a2 < t3.series[t3.maxValsInArrayIndex].length; a2++) for (var s2 = 0, r2 = 0, o2 = 0; o2 < t3.series.length; o2++) null !== t3.series[o2][a2] && x.isNumber(t3.series[o2][a2]) && (t3.series[o2][a2] > 0 ? s2 = s2 + parseFloat(t3.series[o2][a2]) + 1e-4 : r2 += parseFloat(t3.series[o2][a2])), o2 === t3.series.length - 1 && (e2.push(s2), i2.push(r2));
        for (var n2 = 0; n2 < e2.length; n2++) t3.maxY = Math.max(t3.maxY, e2[n2]), t3.minY = Math.min(t3.minY, i2[n2]);
      } }]), t2;
    }();
    var q = function() {
      function t2(e2, i2) {
    ...
    var at = function() {
      ...
      return r(t2, [{ key: "getxAxisLabelsCoords", value: function() {
        ...
        var t3, e2 = this.w;
        if (!e2.globals.hasGroups) return { width: 0, height: 0 };
    ...
    var lt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        for (var o2 = e2.globals.legendFormatter, n2 = e2.config.legend.inverseOrder, l2 = n2 ? a2.length - 1 : 0; n2 ? l2 >= 0 : l2 <= a2.length - 1; n2 ? l2-- : l2++) {
          ...
          if (e2.globals.collapsedSeries.length > 0) for (var g2 = 0; g2 < e2.globals.collapsedSeries.length; g2++) e2.globals.collapsedSeries[g2].index === l2 && (c2 = true);
          if (e2.globals.ancillaryCollapsedSeriesIndices.length > 0) for (var u2 = 0; u2 < e2.globals.ancillaryCollapsedSeriesIndices.length; u2++) e2.globals.ancillaryCollapsedSeriesIndices[u2] === l2 && (d2 = true);
          ...
          if (!e2.config.legend.showForZeroSeries) 0 === M2.getSeriesTotalByIndex(l2) && M2.seriesHaveSameValues(l2) && !M2.isSeriesNull(l2) && -1 === e2.globals.collapsedSeriesIndices.indexOf(l2) && -1 === e2.globals.ancillaryCollapsedSeriesIndices.indexOf(l2) && L2.classList.add("apexcharts-hidden-zero-series");
        ...
        } else !t3.target.classList.contains("apexcharts-inactive-legend") && i2 && new O(this.ctx).toggleSeriesOnHover(t3, t3.target);
    ...
    var ht = function() {
      ...
      return r(t2, [{ key: "createToolbar", value: function() {
        ...
        for (var i2 = 0; i2 < e2.length; i2++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i2].innerHTML = e2[i2].title, m.setAttrs(this.elMenuItems[i2], { class: "apexcharts-menu-item ".concat(e2[i2].name), title: e2[i2].title }), this.elMenu.appendChild(this.elMenuItems[i2]);
    ...
    var ut = function() {
      ...
      return r(t2, [{ key: "moveXCrosshairs", value: function(t3) {
        ...
        } else a2.globals.isBarHorizontal || (o2.ttHeight / 2 + h2 > a2.globals.gridHeight && (h2 = a2.globals.gridHeight - o2.ttHeight + a2.globals.translateY), h2 < 0 && (h2 = 0));
      ...
      return r(t2, [{ key: "getElTooltip", value: function(t3) {
        ...
        if (o2) {
          if (i2.tooltipRect = { x: 0, y: 0, ttWidth: o2.getBoundingClientRect().width, ttHeight: o2.getBoundingClientRect().height }, i2.e = s2, i2.tooltipUtil.hasBars() && !r2.globals.comboCharts && !i2.isBarShared) {
            if (this.tConfig.onDatasetHover.highlightDataSeries) new O(e2).toggleSeriesOnHover(s2, s2.target.parentNode);
          }
        ...
        if (this.clientY = l2, this.clientX = n2, r2.globals.capturedSeriesIndex = -1, r2.globals.capturedDataPointIndex = -1, l2 < o2.top || l2 > o2.top + o2.height) this.handleMouseOut(s2);
          ...
          if ("mousemove" === a2.type || "touchmove" === a2.type || "mouseup" === a2.type) {
            ...
            if (this.yaxisTooltips.length) for (var p2 = 0; p2 < r2.config.yaxis.length; p2++) this.axesTooltip.drawYaxisTooltipText(p2, l2, this.xyRatios);
        ...
        if (o2.config.legend.tooltipHoverFormatter) {
          ...
          for (var g2 = 0; g2 < d2.length; g2++) {
            ...
            if (r2) u2.innerHTML = o2.globals.collapsedSeriesIndices.indexOf(f2) < 0 ? x2 : p2;
            else if (u2.innerHTML = f2 === i2 ? x2 : p2, i2 === f2) break;
          }
        }
        if (r2) {
          if (n2.tooltipLabels.drawSeriesTexts({ ttItems: s2, i: i2, j: a2, shared: !this.showOnIntersect && this.tConfig.shared }), l2 && (o2.globals.markers.largestSize > 0 ? n2.marker.enlargePoints(a2) : n2.tooltipPosition.moveDynamicPointsOnHover(a2)), this.tooltipUtil.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(h2), this.barSeriesHeight > 0)) {
            ...
            for (var y2 = 0; y2 < v2.length; y2++) b2.pathMouseEnter(v2[y2]);
          }
        } else n2.tooltipLabels.drawSeriesTexts({ shared: false, ttItems: s2, i: i2, j: a2 }), this.tooltipUtil.hasBars() && n2.tooltipPosition.moveStickyTooltipOverBars(a2), l2 && n2.tooltipPosition.moveMarkers(i2, a2);
      } }]), t2;
    }();
    var vt = function() {
      function t2(e2) {
    ...
    var mt = function() {
      ...
      return r(t2, [{ key: "initVariables", value: function(t3) {
        ...
        for (var o2 = e2.length - 1; o2 >= 0; o2--) this.barCtx.zeroSerieses.indexOf(o2) > -1 && o2 === this.radiusOnSeriesNumber && (this.barCtx.radiusOnSeriesNumber -= 1);
        for (var n2 = e2.length - 1; n2 >= 0; n2--) i2.globals.collapsedSeriesIndices.indexOf(this.barCtx.radiusOnSeriesNumber) > -1 && (this.barCtx.radiusOnSeriesNumber -= 1);
    ...
    var wt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        for (var o2 = 0; o2 < t3.length; o2++) t3[o2].length > 0 && (this.totalItems += t3[o2].length);
        ...
        }, d2 = 0, g2 = 0; d2 < t3.length; d2++, g2++) c2(d2, g2);
        return n2;
        ...
        for (var e2, i3 = t3.indexes, a2 = t3.barHeight, s3 = t3.strokeWidth, r2 = t3.zeroW, o2 = t3.x, n2 = t3.y, l2 = t3.yDivision, h2 = t3.elSeries, c2 = this.w, d2 = n2, g2 = i3.i, u2 = i3.j, f2 = 0, p2 = 0; p2 < this.prevXF.length; p2++) f2 += this.prevXF[p2][u2];
        if (g2 > 0) {
          var x2 = r2;
        ...
        for (var u2, f2 = i3, p2 = 0, x2 = 0; x2 < this.prevYF.length; x2++) p2 += isNaN(this.prevYF[x2][c2]) ? 0 : this.prevYF[x2][c2];
        if (h2 > 0 && !l2.globals.isXNumeric || h2 > 0 && l2.globals.isXNumeric && l2.globals.seriesX[h2 - 1][c2] === l2.globals.seriesX[h2][c2]) {
          ...
          if (void 0 !== this.prevY[h2 - 1]) {
            for (var y2 = 1; y2 < m2; y2++) if (!isNaN(this.prevY[h2 - y2][c2])) {
        ...
        for (var r2 = s3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), o2 = 0; o2 < t3.length; o2++) {
          ...
          for (var y2 = s3.group({ class: "apexcharts-datalabels", "data:realIndex": u2 }), w2 = s3.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), k2 = 0; k2 < a2.globals.dataPoints; k2++) {
            ...
            if (g2 = v2.yDivision, p2 = v2.barHeight, this.isHorizontal) {
              ...
              var I2 = (g2 - p2 * M2) / 2;
              if (void 0 === a2.config.series[o2].data[k2]) break;
            ...
            } else p2 = (L2 = this.drawRangeColumnPaths(e({ indexes: { i: o2, j: k2, realIndex: u2 }, zeroH: l2, barWidth: b2, xDivision: n2 }, T2))).barHeight;
    ...
    var It = function() {
      ...
      return r(t2, [{ key: "sameValueSeriesFix", value: function(t3, e2) {
        ...
        if (void 0 !== (null === (e2 = a2[i2]) || void 0 === e2 ? void 0 : e2[0])) s2 = (r2 = o2.config.chart.stacked && i2 > 0 ? this.lineCtx.prevSeriesY[i2 - 1][0] : this.lineCtx.zeroY) - a2[i2][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] + 2 * (this.lineCtx.isReversed ? a2[i2][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0);
    ...
    var zt = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        if (r2.config.chart.stacked) for (var T2 = c2.length; T2 > 0; T2--) l2.add(c2[T2 - 1]);
        else for (var M2 = 0; M2 < c2.length; M2++) l2.add(c2[M2]);
        return l2;
        ...
        if ("area" === i2) for (var f2 = l2.fillPath({ seriesNumber: a2 }), p2 = 0; p2 < r2.areaPaths.length; p2++) {
        ...
        for (var I2 = n2, z2 = 0; z2 < a2; z2++) {
          ...
          } else o2 += this.xDivision;
          if (w2.config.chart.stacked) if (r2 > 0 && w2.globals.collapsedSeries.length < w2.config.series.length - 1) {
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, i2) {
        ...
        for (var v2 = g2, m2 = 0; m2 < o2; m2++) {
          if (l2 = "hour", f2 >= 24) f2 = 0, l2 = "day", b2 = h2(p2 += 1, b2).month, b2 = c2(p2, b2);
        ...
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.minutesWidthOnXAxis, h2 = t3.secondsWidthOnXAxis, c2 = t3.numberOfMinutes, d2 = a2 + 1, g2 = r2, u2 = o2, f2 = n2, p2 = s2, b2 = (60 - i2 - e2 / 1e3) * h2, v2 = 0; v2 < c2; v2++) d2 >= 60 && (d2 = 0, 24 === (p2 += 1) && (p2 = 0)), this.timeScaleArray.push({ position: b2, value: d2, unit: "minute", hour: p2, minute: d2, day: g2, year: this._getYear(f2, u2, 0), month: x.monthMod(u2) }), b2 += l2, d2++;
      } }, { key: "generateSecondScale", value: function(t3) {
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.secondsWidthOnXAxis, h2 = t3.numberOfSeconds, c2 = i2 + 1, d2 = a2, g2 = r2, u2 = o2, f2 = n2, p2 = s2, b2 = (1e3 - e2) / 1e3 * l2, v2 = 0; v2 < h2; v2++) c2 >= 60 && (c2 = 0, ++d2 >= 60 && (d2 = 0, 24 === ++p2 && (p2 = 0))), this.timeScaleArray.push({ position: b2, value: c2, unit: "second", hour: p2, minute: d2, second: c2, day: g2, year: this._getYear(f2, u2, 0), month: x.monthMod(u2) }), b2 += l2, c2++;
    ...
    var Rt = function() {
      ...
      return r(t2, [{ key: "setupElements", value: function() {
        ...
        if (s2.comboCharts) {
          if (o2.series.length > 0 && v2.push(f2.draw(o2.series, "area", o2.i)), h2.series.length > 0) if (i2.config.chart.stacked) {
    ...
    Xt = "undefined" != typeof window ? window : void 0, Et = function(t2, e2) {
      ...
      a2.PathArray = function(t3, e3) {
        ...
        for (var s3 = m2.length - 1; s3 >= 0; --s3) this[m2[s3]] = null != t3[m2[s3]] ? t3[m2[s3]] : e3[m2[s3]];
        ...
        for (var t3 = a2.parser.native.createSVGMatrix(), e3 = m2.length - 1; e3 >= 0; e3--) t3[m2[e3]] = this[m2[e3]];
        return t3;
      }, toString: function() {
    ...
    * Copyright (c) 2016 Wout Fierens; Licensed MIT */
    (function() {
      ...
      function r2(t3) {
        if (!Array.isArray(t3)) return t3;
        for (var e3 = 0, i3 = t3.length, a3 = []; e3 < i3; e3++) a3.push(t3[e3]);
        return a3.join(" ");
      }
      function o2() {
        var t3 = function() {
        ...
        switch (t3[0]) {
          ...
          case "A":
            e3 = function(t4, e4) {
              ...
              if (0 === T2 || 0 === M2 || F2.x === R2.x && F2.y === R2.y) return [["C", F2.x, F2.y, R2.x, R2.y, R2.x, R2.y]];
              ...
              for (b2[0][0] = b2[0][1].clone(), b2[b2.length - 1][2] = b2[b2.length - 1][1].clone(), s3 = new SVG.Matrix().rotate(I2).scale(T2, M2).rotate(-I2), k2 = 0, A2 = b2.length; k2 < A2; k2++) b2[k2][0] = b2[k2][0].transform(s3), b2[k2][1] = b2[k2][1].transform(s3), b2[k2][2] = b2[k2][2].transform(s3);
    ...
    var Wt = function() {
      ...
      return r(t2, [{ key: "render", value: function() {
        ...
        return new Promise(function(s2, r2) {
          ...
          })), "back" === a2.config.annotations.position && (a2.globals.dom.Paper.add(a2.globals.dom.elAnnotations), i2.annotations.drawAxesAnnotations()), Array.isArray(e2.elGraph)) for (var h2 = 0; h2 < e2.elGraph.length; h2++) a2.globals.dom.elGraphical.add(e2.elGraph[h2]);
