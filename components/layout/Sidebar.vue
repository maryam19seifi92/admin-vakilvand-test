<template>
            ...
            <div class="h-full bg-white dark:bg-[#0e1726]">
                <div class="flex items-center justify-between px-4 py-3">
                    <NuxtLink to="/" class="main-logo flex shrink-0 items-center">
                        ...
                        <span class="align-middle text-2xl font-semibold dark:text-white-light lg:inline ltr:ml-1.5 rtl:mr-1.5">VRISTO</span>
                    </NuxtLink>
                    <a
                        href="javascript:;"
 ...
 -->
                                    ...
                                    <li class="nav-item">
                                        <NuxtLink to="/client" class="group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                                <icon-menu-users class="shrink-0 group-hover:!text-primary" />
                                                <span class="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3"> مخاطبین </span>
                                            </div>
                                        </NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                        <NuxtLink to="/task" class="group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                                <IconListCheck class="shrink-0 group-hover:!text-primary" />
                                                <span class="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3"> وظایف </span>
                                            </div>
                                        </NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                        <NuxtLink to="/matter" class="group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">{{ $t('forms') }}</span>
                                    </div>
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">{{ $t('users') }}</span>
                                    </div>
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">{{ $t('pages') }}</span>
                                    </div>
